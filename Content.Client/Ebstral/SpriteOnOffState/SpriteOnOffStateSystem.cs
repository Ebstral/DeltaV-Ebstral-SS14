using Content.Shared.Ebstral.SpriteOnOffState; // название П.И. (пространства имён) в которую входит основной скрипт системы
using Robust.Client.GameObjects;

namespace Content.Client.Ebstral.SpriteOnOffState; // название П.И. в которую входит скрипт, в основном это расположение скрипта
