...
using Content.Shared.Ebstral.Utilitys.PopupOnInteract;
using Content.Shared.Ebstral.Utilitys.LogMessageSender;

namespace Content.Client.Ebstral.Utilitys.LogMessageSender;
