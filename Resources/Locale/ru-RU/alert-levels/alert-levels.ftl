...
alert-level-sierra-announcement = Центральное командование объявило на станции код уровнем угрозы: "Сьерра", обьявлен карантин полная изоляция всего экипажа станции, все шаттлы должны немедленно пристыковаться к станции или будут сбиты. Отделу службы безопасности должна постоянно иметь при себе оружие. Гражданский персонал обязан немедленно пройти в свои отделы. Службе Безопасности разрешено применение летальной силы за неподчинение.
